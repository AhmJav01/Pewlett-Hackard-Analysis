...
SELECT COUNT (table_one.title), table_one.title
INTO retiring_titles
FROM table_one
GROUP BY table_one.title
ORDER BY COUNT(table_one.title) DESC;
-- help with descending by count https://stackoverflow.com/questions/9545637/sql-order-by-count
